...
export type FastifyAdapterConstructorParam = ConstructorParameters<typeof FastifyAdapter>[0]
...
export interface BootstrapParam {
  readonly fastifyOption: FastifyAdapterConstructorParam | (() => FastifyAdapterConstructorParam)
